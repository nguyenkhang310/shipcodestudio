...
const projects = [
  ...
  { 
    ...
    approach: "Xây dựng hệ thống phân quyền đa cấp bậc. Ứng dụng kiến trúc Microservices, tích hợp Payment Gateway và Dashboard phân tích real-time.",
  ...
  { 
    ...
    category: "Kỹ thuật phần mềm", 
    approach: "Phát triển App iOS & Android chuẩn UI/UX. Tích hợp bản đồ, định vị GPS, xử lý socket real-time cho các ứng dụng đặt xe, giao đồ ăn.",
  ...
  { 
    ...
    category: "Kỹ thuật phần mềm", 
    approach: "Thiết kế hệ thống thương mại điện tử chịu tải cao. Áp dụng Redis caching, RabbitMQ cho xử lý đơn hàng và tối ưu truy vấn.",
  ...
  { 
    ...
    approach: "Áp dụng Deep Learning nhận diện khuôn mặt, biển số xe, hoặc phân loại hình ảnh y khoa. Tối ưu tốc độ xử lý trên Edge devices.",
  ...
  { 
    ...
    category: "Trí tuệ nhân tạo", 
    approach: "Huấn luyện Chatbot thông minh hỗ trợ khách hàng, phân tích sắc thái bình luận (Sentiment Analysis) sử dụng các mô hình Transformers.",
  ...
  { 
    ...
    approach: "Lập trình vi điều khiển thu thập dữ liệu cảm biến. Xây dựng Web Dashboard theo dõi và điều khiển thiết bị qua giao thức MQTT.",
  ...
  { 
    ...
    category: "Hệ thống nhúng", 
    approach: "Phát triển thuật toán dò đường, tránh vật cản cho Robot/Xe tự hành sử dụng cảm biến Lidar, siêu âm kết hợp thuật toán PID.",
    stack: "Arduino · ROS · C++" 
  },
  // Khoa học dữ liệu
  { 
    ...
    approach: "Thu thập dữ liệu lớn, làm sạch và phân tích. Áp dụng thuật toán Collaborative Filtering để xây dựng hệ thống gợi ý sản phẩm.",
  ...
  { 
    ...
    approach: "Nghiên cứu lỗ hổng bảo mật, phát triển hệ thống phát hiện xâm nhập mạng (IDS/IPS) và thiết lập cảnh báo theo thời gian thực.",
  ...
  { 
    ...
    category: "An toàn thông tin", 
    approach: "Xây dựng ứng dụng phi tập trung (DApp) trên mạng lưới Blockchain. Lập trình Smart Contract minh bạch, chống tấn công Re-entrancy.",
  ...
  { 
    ...
    category: "Kỹ thuật phần mềm", 
    approach: "Phát triển hệ thống quản lý chấm công, tính lương tự động. Tích hợp AI nhận diện khuôn mặt điểm danh và xuất báo cáo động.",
  ...
  { 
    ...
    category: "Kỹ thuật phần mềm", 
    approach: "Xây dựng ứng dụng đặt lịch hẹn phòng khám, spa, hoặc sân bóng. Quản lý trạng thái slot real-time và gửi nhắc nhở qua SMS/Email.",
  ...
  { 
    ...
    category: "Trí tuệ nhân tạo", 
    approach: "Sử dụng mô hình Whisper hoặc các kiến trúc Deep Learning để chuyển đổi giọng nói tiếng Việt thành văn bản với độ chính xác cao.",
  ...
  { 
    ...
    category: "Khoa học dữ liệu", 
    approach: "Cào dữ liệu (Crawling) thị trường. Sử dụng mô hình chuỗi thời gian (ARIMA, LSTM) để dự đoán xu hướng giá cổ phiếu và vẽ biểu đồ.",
  ...
  { 
    ...
    category: "Hệ thống nhúng", 
    approach: "Hệ thống tưới tiêu tự động dựa trên độ ẩm đất và thời tiết. Dữ liệu cảm biến truyền về server qua mạng LoRa hoặc 4G để theo dõi.",
  ...
  { 
    ...
    category: "An toàn thông tin", 
    approach: "Dùng kỹ thuật Reverse Engineering để dịch ngược và phân tích hành vi mã độc. Xây dựng môi trường Sandbox an toàn để kiểm thử.",
    stack: "C/C++ · Assembly · Python" 
  },
];

const filters = ["Tất cả", "Kỹ thuật phần mềm", "Trí tuệ nhân tạo", "Hệ thống nhúng", "Khoa học dữ liệu", "An toàn thông tin"];

const filterCounts: Record<string, number> = {};
filters.forEach((f) => {
  filterCounts[f] = f === "Tất cả" ? projects.length : projects.filter((p) => p.category === f).length;
});
  ...
  return (
    <Page>
      <PageHeader
        index="04"
        eyebrow="Dự án"
        title={<>Những dự án đã <span className="text-gradient">bàn giao</span> thành công.</>}
      ...
      <div className="container">
        ...
        <div className="mb-8 sm:mb-10 flex gap-2 overflow-x-auto border-b border-border/70 pb-4 sm:pb-5 sm:flex-wrap scrollbar-none -mx-4 px-4 sm:mx-0 sm:px-0">
          {filters.map((f) => (
            ...
            >
              {f}
              <span className={`ml-2 inline-flex h-5 min-w-5 items-center justify-center rounded-full text-[10px] font-bold ${
                active === f
          ...
          <AnimatePresence mode="popLayout">
            {filtered.map((p) => (
              ...
              >
                ...
                <div className="p-6">
                  <h3 className="font-display font-semibold text-lg mb-3 text-foreground group-hover:text-primary transition-colors duration-300">
                    {p.title}
                  </h3>
                  <p className="text-sm text-muted-foreground mb-5 line-clamp-3 leading-7 group-hover:text-foreground/70 transition-colors duration-300">
                    {p.approach}
                  </p>
        ...
        {filtered.length === 0 && (
          ...
          >
            ...
            <p className="text-muted-foreground">Chưa có dự án trong mảng này.</p>
          </motion.div>
        )}
        ...
        >
          ...
          <div className="relative">
            ...
            <p className="text-muted-foreground mb-8">Bắt đầu hành trình cùng ShipCode hôm nay.</p>
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.97 }}>
              <Button asChild variant="hero" size="xl" className="group shadow-lg shadow-primary/30 hover:shadow-primary/50 transition-shadow">
                <Link to="/lien-he">
                  Bắt đầu dự án <ArrowRight className="transition-transform group-hover:translate-x-1" />
                </Link>
              </Button>
            </motion.div>
          </div>
